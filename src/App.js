...
function App() {
  ...
  const loadModels = (modelCkpt) => {
    fetch("http://127.0.0.1:7861/sdapi/v1/sd-models", {
      method: "GET",
      headers: {
  ...
  const getConfig = () => {
    fetch("http://127.0.0.1:7861/sdapi/v1/options", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
  ...
  const generateImg2Img = (inputImg, control, mask, i, letter) => {
    return fetch("http://127.0.0.1:7861/sdapi/v1/img2img", {
      method: "POST",
      cache: "no-cache",
      headers: {
        "Content-Type": "application/json",
  ...
  const generateTxt2Img = (prompt) => {
    return fetch("http://127.0.0.1:7861/sdapi/v1/txt2img", {
      method: "POST",
      cache: "no-cache",
      headers: {
        "Content-Type": "application/json",
